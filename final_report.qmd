---
title: "The Magical Disappearing Swing Voter: Microtargeting and Commercial Data in Electoral Campaigns"
subtitle: "DSAN 5450 — Final Project"
author: "Isak Dai"
date: "May 8, 2026"
abstract: "This project considers the use of consumer data in electoral campaigns, specifically how campaigns use datasets beyond the voterfile to microtarget voters to increase support and turnout. Using data from the Cooperative Election Study, I build random forest models to predict voters' partisan preferences. I simulate the effects of adding consumer data by comparing the accuracy of the threee models – the first built only with age and gender, the second adding race, and the third adding a proxy for consumer data in the form of education, income, marital status, employment, home ownership, and stock market participation. I find that adding consumer data to the model results in marginal improvements in the accuracy of the model, but with more robust changes with certain demographic groups like Black voters and voters with less than a high school education. I find that the use of consumer data in political trageting should be limited to avoid a self-fulfilling prophecy of voter exclusion and apathy."
---
...
There are other structural issues driving increased voter apathy and cynicism, from rampant gerrymandering to increased corruption in government. However, the use of precise modeling to determine voter behavior may be powerful tool for campaigns to narrow and silo the electorate, potentially exacerbating these issues. It is easy to imagine a self-reinforcing cycle wherein voters predicted to have low likelihood to vote are contacted less often, leading to increased apathy or less knowledge of the democratic process. The modeling of voter behavior could thus become a self-fulfilling prophecy, with predictions of turnout sharpened by consumer data. The same could be true for political polarization. If campaigns begin only talking to their base for GOTV or potential swing voters, there might be a feedback loop where volunteers and candidates become more isolated from the broader electorate. The same would be true for voters who no longer get direct outreach from one party, creating a one-sided political landscape. 

The larger ethics of political data modeling are ripe for discussion, but in particular, the use of consumer data to microtarget voters unlocks a level of precision in targeting that could uniquely hollow out the democratic process. This is especially troubling for certain demographic groups more likely to be excluded from the process according to our results, like Black voters and voters with a high school education or less. If the data available to campaigns to model voter behavior were restricted to only what they could find on the voter file, these groups might be less likely to be excluded from the democratic process. Keeping consumer data out of campaigns' hands would be a step in the right direction, especially as it could limit their ability to model certain sensitive variables like education, race, or income.
